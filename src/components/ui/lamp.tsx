...
export function Lamp() {
    return (
        <LampContainer>
            ...
            >
                Our unique LED advertising trucks are designed to showcase your message, ensuring maximum visibility.
            </motion.p>
        </LampContainer>
    );
}
...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex h-[50vh] overflow-hidden md:overflow-visible flex-col items-center justify-center bg-slate-950 w-full rounded-md z-0 md:h-[calc(100vh-70px)]",
                className
            )}
        >
            <div className="relative flex w-full items-center justify-center z-0 translate-y-[70px] md:translate-y-0">
                <motion.div
